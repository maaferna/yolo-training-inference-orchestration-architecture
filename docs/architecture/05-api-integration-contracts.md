...
### Training Request with Django Configuration

When Django configuration models (ProjectConfiguration, ClassSet, DatasetConfig) are used, the training request includes a dataset YAML path auto-generated from database state.
...
#### Request Payload (from Django Configuration)

```json
{
  "project_name": "ILLUSTRATIVE_PROJECT_NAME",
  "class_set_id": 5,
  "dataset_yaml_path": "/shared_storage/configs/yaml_TIMESTAMP_1717857600.yaml",
  "model_size": "m",
  "epochs": 50,
  "batch_size": 32,
  "learning_rate": 0.001,
  ...
  "num_seeds": 3,
  "imgsz": 640,
  "request_id": "django_req_proj_5_run_1",
  "user_id": 42
}
```

**Key differences from manual request**:
- `dataset_yaml_path` generated by DatasetConfig model (auto-generated from ProjectConfiguration + ClassSet)
- `project_name` and `class_set_id` included for audit trail
- `request_id` includes project identifier for tracking

#### YAML File Content (generated by Django)

Located at `/shared_storage/configs/yaml_TIMESTAMP_1717857600.yaml`:
...
**Note**: `names` list must be inline-style (as shown) for Ultralytics compatibility. Django DatasetConfig uses custom PyYAML serializer to enforce this format.
